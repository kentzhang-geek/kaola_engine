...
//    this->obj->get_property()->position = glm::vec3(0.0);
//    this->obj->set_control_authority(GL3D_OBJ_ENABLE_NONE);
//    this->obj->set_render_authority(GL3D_SCENE_DRAW_NORMAL);
//    this->obj->set_obj_type(this->obj->type_default);
//}

GL3D_MODEL_PARAM(12, "Aerith.3ds") {
    this->obj->set_repeat(false);
    this->obj->get_property()->scale_unit = gl3d::scale::m;
    this->obj->get_property()->position = glm::vec3(0.0);
    this->obj->set_control_authority(GL3D_OBJ_ENABLE_ALL);
    this->obj->set_render_authority(GL3D_SCENE_DRAW_NORMAL);
    this->obj->set_obj_type(this->obj->type_default);
    this->obj->coordinate_system = abstract_object::right_hand;
}
