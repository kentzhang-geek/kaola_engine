...
//class gauss : public gl3d_post_processer {
//public:
...
//        gl3d::shader_param * current_shader_param = GL3D_GET_PARAM("post_process_gauss");
...
//        one_scene->get_property()->global_shader = string("post_process_gauss");
...
//    void deel_with_src(gl3d_general_texture * src) {};
//};
//GL3D_ADD_POST_PROCESSER(gauss);
//GL3D_LOAD_SHADER(post_process_gauss,
//                 post_process_gauss.vdata,
//                 post_process_gauss.fdata);

//GL3D_SHADER_PARAM(post_process_gauss) {
//    GLuint pro = GL3D_GET_SHADER("post_process_gauss")->getProgramID();
