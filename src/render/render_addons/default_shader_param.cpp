...
GL3D_SHADER_PARAM(light) {
    GLuint pro = GL3D_GET_SHADER("light")->getProgramID();
...
GL3D_SHADER_PARAM(sunshine) {
    GLuint pro = GL3D_GET_SHADER("sunshine")->getProgramID();
...
GL3D_SHADER_PARAM(geo) {
    GLuint pro = GL3D_GET_SHADER("geo")->getProgramID();
