...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qqq->setText(QApplication::translate("MainWindow", "action", 0));
    } // retranslateUi
